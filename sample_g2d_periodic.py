...
# Exercise 5: replace this with model_folder you computed
...
# Exercise 6: IInterpolate between two latent codes
# i.e. z_t = (1-t)*z_0 + t*z_1 for two latent codes z_0, z_1
# And save every image in between
